...
type AppStack = ModuleStack [LoggingT, ActorT, NetworkT, SyncT, GLFWT, LambdaCubeT] IO
...
newtype AppMonad a = AppMonad (AppStack a)
  deriving (Functor, Applicative, Monad, MonadFix, MonadIO, LoggingMonad, NetworkMonad, ActorMonad, MonadCatch, MonadThrow, MonadLambdaCube, MonadGLFW)
